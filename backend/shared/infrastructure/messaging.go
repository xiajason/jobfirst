...
func (q *RedisStreamsQueue) createConsumerGroup(ctx context.Context, streamKey, groupKey string) error {
	// 检查消费者组是否存在
...
// ackMessage 确认消息
func (q *RedisStreamsQueue) ackMessage(ctx context.Context, streamKey, groupKey, messageID string) {
