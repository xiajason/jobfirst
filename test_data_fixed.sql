...
-- 插入用户数据（使用正确的字段）
INSERT INTO users (id, username, email, password_hash, phone, avatar_url, status, created_at, updated_at) VALUES
(1, 'test_user', 'test@example.com', '$2a$10$example_hash', '13800138000', '/images/avatar/user1.jpg', 'active', NOW(), NOW()),
(2, 'demo_user', 'demo@example.com', '$2a$10$example_hash', '13800138001', '/images/avatar/user2.jpg', 'active', NOW(), NOW()),
(3, 'sample_user', 'sample@example.com', '$2a$10$example_hash', '13800138002', '/images/avatar/user3.jpg', 'active', NOW(), NOW());
